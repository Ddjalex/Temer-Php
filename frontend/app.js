...
async function displayProperties(properties) {
        ...
        <div class="property-card" data-property-id="${escapeHtml(property.id)}">
            ...
            <div class="property-card-content">
                ...
                <div class="property-contact-buttons">
                    <a href="https://wa.me/${phone}?text=${whatsappMessage}" class="contact-btn whatsapp-btn" onclick="event.stopPropagation()">
                    ...
                    <a href="tel:${escapeHtml(contactPhone)}" class="contact-btn call-btn" onclick="event.stopPropagation()">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    document.querySelectorAll('.property-card').forEach(card => {
        card.addEventListener('click', (e) => {
            if (!e.target.closest('.contact-btn') && !e.target.closest('.view-details-btn')) {
