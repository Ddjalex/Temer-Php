...
<body>
    ...
    <div class="floating-contact">
        <a href="#" id="whatsappBtn" class="floating-btn whatsapp-btn" title="Chat on WhatsApp" style="display:none;">
        ...
        <a href="#" id="callBtn" class="floating-btn call-btn" title="Call Us" style="display:none;">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
